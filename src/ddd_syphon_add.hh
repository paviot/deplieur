...
#ifndef __CPN_DDD__DDD_SYPHON_ADD__
#define __CPN_DDD__DDD_SYPHON_ADD__
...
namespace cpn_ddd
{
   ...
   * \brief ...
   */
  class ddd_syphon_add_t : public ddd_compare_add_t
  {
  private:
     ...
     */
    ddd_syphon_add_t (const ddd_syphon_add_t& to_copy);

    /**
     * \brief Unavailable assignment operator.
     */
    ddd_syphon_add_t& operator= (const ddd_syphon_add_t& to_copy);
...
#endif //__CPN_DDD__DDD_SYPHON_ADD__
