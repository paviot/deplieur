...
namespace cpn_ddd
{
   ...
   * \brief ...
   */
  class ddd_syphon_reference_t : public ddd_compare_reference_t
  {
  private:
     ...
     */
    ddd_syphon_reference_t (const ddd_syphon_reference_t& to_copy);

    /**
     * \brief Unavailable assignment operator.
     */
    ddd_syphon_reference_t& operator= (const ddd_syphon_reference_t& to_copy);
  ...
  public:
     ...
     */
    ddd_syphon_reference_t (net_t& net,
