...
#ifndef __CPN_DDD__DDD_SYPHON_REFERENCE__
#define __CPN_DDD__DDD_SYPHON_REFERENCE__
...
namespace cpn_ddd
{
   ...
   * \brief ...
   */
  class ddd_syphon_transitions_t : public ddd_compare_reference_t
  {
  private:
     ...
     */
    ddd_syphon_transitions_t (const ddd_syphon_transitions_t& to_copy);

    /**
     * \brief Unavailable assignment operator.
     */
    ddd_syphon_transitions_t& operator= (const ddd_syphon_transitions_t& to_copy);
  ...
  protected:
    ...
    void remove_transitions (net_t& net, arcs_t& arcs);

    arcs_t arcs_;

    std::map<identifier_t, DDD> old_values_;
  ...
  public:
     ...
     */
    ddd_syphon_transitions_t (net_t& net,
...
#endif //__CPN_DDD__DDD_SYPHON_REFERENCE__
