...
namespace cpn_ddd
{
  ...
  ddd_compare_add_t::ddd_compare_add_t (net_t& net,
  ...
  ddd_compare_add_t::~ddd_compare_add_t ()
  {}

  Hom
  ddd_compare_add_t::select_cst (const values_map_t& values) const
  {
    Hom result(Hom::id);
  ...
  Hom
  ddd_compare_add_t::select_var (const variables_map_t& variables,
  ...
  Hom
  ddd_compare_add_t::remove (const values_map_t& values) const
  {
    Hom result(Hom::id);
    for (values_map_t::const_iterator i = values.begin();
	 i != values.end();
  ...
  Hom
  ddd_compare_add_t::remove (const variables_map_t& variables) const
  {
    Hom result(Hom::id);
  ...
  Hom
  ddd_compare_add_t::shift_inc (const variables_map_t& variables,
				      const values_map_t& elements) const
  {
    Hom result(Hom::id);
    variables_map_t::const_iterator i;
  ...
  Hom
  ddd_compare_add_t::shift_dec (const variables_map_t& variables,
				      const values_map_t& elements) const
  {
    Hom result(Hom::id);
    variables_map_t::const_iterator i;
  ...
  Hom
  ddd_compare_add_t::rename (const variables_map_t& variables) const
  {
    Hom result(Hom::id);
  ...
  Hom
  ddd_compare_add_t::insert (const values_map_t& completes) const
  {
    Hom result(Hom::id);
  ...
  /*
  Hom
  ddd_compare_add_t::move (const variables_map_t& variables,
  ...
  */
  ...
  Hom
  ddd_compare_add_t::rename (const renames_map_t& renames) const
  {
    Hom result(Hom::id);
  ...
  Hom
  ddd_compare_add_t::copy (const variables_map_t& variables,
  ...
  Hom
  ddd_compare_add_t::remove (const renames_map_t& renames) const
  {
    Hom result(Hom::id);
    for (renames_map_t::const_iterator i = renames.begin();
	 i != renames.end();
   ...
   */
  void
  ddd_compare_add_t::remove_places (net_t& net,
					  bool marked) const
  {
	...
	if (marking != NULL)
	  {
	    ...
	    //	    cerr << "Mark size : " << mark_ddd.nbStates() << endl;
	    //	    cerr << "Current size : " << current_ddd.nbStates() << endl;
	    // Compute result :
	    if (marked)
   ...
   */
  void
  ddd_compare_add_t::convert_to_transition (const unfold_ddd_t& transition,
   ...
   */
  void
  ddd_compare_add_t::convert_to_place (const unfold_ddd_t& place,
  ...
  /*
  Hom
  ddd_compare_add_t::convert_to_transition_temp (const unfold_ddd_t& transition,
						       const unfold_ddd_t& place,
						       const CFuncTerm& term) const
  {
    variables_map_t variables;
  ...
  */
					    ...
					    const Arc* const arc) const
  {
    ...
    for (std::list<CFuncTerm>::const_iterator i = terms.begin();
	 i != terms.end();
	 ++i)
      result = result & this->convert_to_transition(transition, place, *i);
