...
#ifndef __CPN_DDD__DDD_SYPHON_BUBBLE__
#define __CPN_DDD__DDD_SYPHON_BUBBLE__
...
namespace cpn_ddd
{
   ...
   * \brief ...
   */
  class ddd_syphon_bubble_t : public ddd_compare_bubble_t
  {
  private:
     ...
     */
    ddd_syphon_bubble_t (const ddd_syphon_bubble_t& to_copy);

    /**
     * \brief Unavailable assignment operator.
     */
    ddd_syphon_bubble_t& operator= (const ddd_syphon_bubble_t& to_copy);
...
#endif //__CPN_DDD__DDD_SYPHON_BUBBLE__
