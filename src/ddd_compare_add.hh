...
#ifndef __CPN_DDD__DDD_COMPARE_ADD__
#define __CPN_DDD__DDD_COMPARE_ADD__
...
namespace cpn_ddd
{
  ...
  class ddd_compare_add_t : public virtual ddd_operation_t
  {
  protected:
...
#endif //__CPN_DDD__DDD_COMPARE_ADD__
